# @devtea2027/excepturi-exercitationem-qui-illum
...
To report a bug or request a feature please open an issue or pull request in [GitHub](https://github.com/devtea2027/excepturi-exercitationem-qui-illum). Please read the `Troublehsooting` section below *before* filing a bug.
...
```
$ npm install @devtea2027/excepturi-exercitationem-qui-illum --save
```

In your project file:
```javascript
const urlMetadata = require('@devtea2027/excepturi-exercitationem-qui-illum');

try {
  const url = 'https://www.npmjs.com/package/@devtea2027/excepturi-exercitationem-qui-illum';
...
const options = {
  ...
  requestHeaders: {
    'User-Agent': '@devtea2027/excepturi-exercitationem-qui-illum/3.0 (npm module)',
...
try {
  ...
  const response = await fetch('https://www.npmjs.com/package/@devtea2027/excepturi-exercitationem-qui-illum');
